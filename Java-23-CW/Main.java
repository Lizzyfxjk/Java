class Main {
  ...
  void init(){
    // #1
int nums[] = {20, 29, 34, 35, 57, 98, 21, 10, 12, 65, 83};
print (avgDistribution(nums));

    // #2
String[] student_list = {"Winnie", "Lizzy", "John", "Bribean", "Bria"};
print(findStudent(student_list, "Winnie"));
print(findStudent(student_list, "Lizzy"));
...
*/
double avgDistribution(int[] nums){
  int sum = 0;
