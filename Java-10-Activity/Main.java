class Main {
   ...
   System.out.println(gpa(74));
   System.out.println(gpa(89));

   if(isGraduating(12,65))
      System.out.println("Student Graduating");
    else
      System.out.println("Student NOT Graduating");

    if(isGraduating(11,55))
      System.out.println("Student Graduating");
    else
      System.out.println("Student NOT Graduating");

    System.out.println(BMI(165,75));
    System.out.println(BMI(134,75));
    System.out.println(BMI(124,75));

    System.out.println(shippingCost(8));
    System.out.println(shippingCost(30));
    System.out.println(shippingCost(50));

    System.out.println(blueOrViolet(560));
...
*/
  String BMI(double weight, double height){
    double BMI = weight/Math.pow(height, 5)* 605;
...
*/
  boolean blueOrViolet(int freq){
    if (freq >= 560 && freq <= 690 || freq >= 700 && freq <= 760)
      return true;
    else
      return false;
  }
